    ...
    flipBoxList: [
        {
            ...
            showFrontTitle: true,
            frontTitle: "This is a Title",
            showFrontDescription: true,
            frontDescription: "Writing in paragraphs lets your visitor find what they are looking for quickly and easily.",
            showFrontBtn: false,
            frontBtnLink: "/",
            frontBtnText: "Learn More",
            backBgOverlay: true,
            backBgImage: "https://images.pexels.com/photos/2258536/pexels-photo-2258536.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
            showBackImage: true,
            backImage: "https://images.pexels.com/photos/4904563/pexels-photo-4904563.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1",
            showBackIcon: false,
            ...
            showBackTitle: true,
            backTitle: "This is a Title",
            showBackDescription: true,
            backDescription: "This is a paragraph. Writing in paragraphs can be very helpful for your visitors. This lets them find what they are looking for quickly and easily. Make sure your titles stand out from the rest of the text and that all your text is big enough to read.",
            showBackBtn: true,
            backBtnLink: "/",
            backBtnText: "Learn More",
        },
        {
            effects: "push", //flip, push, slide, fade, zoomIn, zoomOut
            flipDirection: "flipLeft", //flipLeft, flipRight, flipTop, flipBottom
            pushDirection: "pushLeft", //pushLeft, pushRight, pushTop, pushBottom
            slideDirection: "slideLeft", //slideLeft, slideRight, slideTop, slideBottom
            frontBgOverlay: false,
        ...
        {
            effects: "slide", //flip, push, slide, fade, zoomIn, zoomOut
            flipDirection: "flipLeft", //flipLeft, flipRight, flipTop, flipBottom
        ...
        {
            effects: "fade", //flip, push, slide, fade, zoomIn, zoomOut
            flipDirection: "flipLeft", //flipLeft, flipRight, flipTop, flipBottom
            pushDirection: "pushRight", //pushLeft, pushRight, pushTop, pushBottom
            slideDirection: "slideLeft", //slideLeft, slideRight, slideTop, slideBottom
            frontBgOverlay: false,
        ...
        {
            effects: "zoomIn", //flip, push, slide, fade, zoomIn, zoomOut
            flipDirection: "flipLeft", //flipLeft, flipRight, flipTop, flipBottom
            pushDirection: "pushRight", //pushLeft, pushRight, pushTop, pushBottom
            slideDirection: "slideLeft", //slideLeft, slideRight, slideTop, slideBottom
            frontBgOverlay: false,
        ...
        {
            effects: "zoomOut", //flip, push, slide, fade, zoomIn, zoomOut
            flipDirection: "flipLeft", //flipLeft, flipRight, flipTop, flipBottom
            pushDirection: "pushRight", //pushLeft, pushRight, pushTop, pushBottom
            slideDirection: "slideLeft", //slideLeft, slideRight, slideTop, slideBottom
            frontBgOverlay: false,
